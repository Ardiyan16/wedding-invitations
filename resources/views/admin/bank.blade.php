@extends('layouts')
@section('content')
<meta name="link-api" link="{{ url('/api/v1/bank/data') }}">
<meta name="link-api-simpan" link="{{ url('/api/v1/bank/simpan') }}">
<meta name="link-api-hapus" link="{{ url('/api/v1/bank/hapus') }}">
<meta name="link-api-update" link="{{ url('/api/v1/bank/update') }}">
<meta name="link-template" link="{{ url('/template') }}">
<meta name="link-image" link="{{ url('/image/bank') }}">
<meta name="link-redirect" link="{{ url('/admin-wedding/data-bank') }}">
...
<section class="section" style="margin-bottom: 10%">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="col-sm-4 mt-3 mb-3" style="margin-left: 10px">
                    <a href="#tambah" class="btn btn-primary btn-sm btn-tambah"><i class="fa fa-plus-circle"></i> Tambah Bank</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 5px">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-bold">List Data Bank</h5>
                    <div class="table-responsive">
                        <table class="table table-stripped" id="data_bank">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Bank</th>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title form-title">Form Tambah Bank</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="row g-3" id="form_addBank" method="POST" enctype="multipart/form-data">
                    <div class="col-12">
                        <label for="inputNanme4" class="form-label">Nama Bank</label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mb-3 px-2 py-2 rounded-pill element-image shadow-sm" style="background: #dee2e6">
                            <input id="upload" type="file" onchange="readURL(this);" accept="image/*" name="logo" class="form-control border-0 image-template">
...
<div class="modal" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title form-title">Form Edit Bank</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="row g-3" id="form_editTemplate" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mb-3 px-2 py-2 rounded-pill element-image shadow-sm" style="background: #dee2e6">
                            ...
                            <input id="upload2" type="file" onchange="readURL(this);" accept="image/*" name="logo" class="form-control border-0 image-template">
...
@endsection
@section('js')
    <script src="{{ url('js/admin/bank.js') }}"></script>
@endsection
