            ...
            <div class="row justify-content-center">
                ...
                <div class="d-flex justify-content-center py-4">
                    <a href="" class="logo d-flex align-items-center w-auto">
                        ...
                        {{-- <span class="d-none d-lg-block">Wedding Invitation</span> --}}
                    </a>
                </div><!-- End Logo -->
                    ...
                    <form class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input view-password" type="checkbox" id="rememberMe">
                                <label class="form-check-label" for="rememberMe">Lihat Password</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 btn-login" type="button">Login</button>
                        </div>
                    </form>
